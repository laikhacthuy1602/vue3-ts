  ...
  <div class="bg-cream">
    ...
    >
      ...
      >
        ...
        >
          <span class="text-yellow-500">Studying</span> Online is now much
          easier
        </h1>
        <p
          data-aos="fade-down"
      ...
      <div class="w-full lg:w-6/12 lg:-mt-10 relative" id="girl">
        ...
        <div
          ...
          class="
            ...
            bottom-14
            -left-4
            sm:left-2 sm:bottom-20
            lg:bottom-24 lg:-left-4
            floating
          "
        >
          <img
    ...
    <div class="flex flex-col md:flex-row items-center mt-12">
      <div data-aos="fade-right" class="md:w-5/12">
        <h1 class="text-darken font-semibold text-3xl leading-tight lg:pr-32">
          <span class="text-yellow-500">Class Management</span> Tools for
          Educators
        </h1>
      ...
      <div data-aos="zoom-in-right" class="md:w-5/12">
        ...
        <button
          class="
            ...
            space-x-3
            pl-3
            border-b border-l border-t border-yellow-500
            text-yellow-500
            font-medium
            my-4
            focus:outline-none
